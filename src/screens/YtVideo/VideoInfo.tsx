                  ...
                  <div className="flex items-center">
					...
					<div className="description">
						<div className="flex gap-2 items-center">
							<p className="description_text">{numeral(localStorage.getItem("views")).format()} views</p>
							<p className="description_text">{moment(localStorage.getItem("date")).format("MMM D, YYYY")}</p>
						</div>
